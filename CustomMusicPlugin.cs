...
[BepInPlugin("com.garnetsunset.straftat.custommusic", "STRAFTAT Custom Music", "1.0.0")]
public class CustomMusicPlugin : BaseUnityPlugin
{
    ...
    void Awake()
    {
        ...
        try
        {
            var harmony = new Harmony("com.garnetsunset.straftat.custommusic");
            harmony.PatchAll();
    ...
    private void CreateManualConfigFile()
    {
        try
        {
            ...
            var configFilePath = Path.Combine(configDir, "com.garnetsunset.straftat.custommusic.cfg");
